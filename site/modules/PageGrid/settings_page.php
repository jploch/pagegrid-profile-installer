...
$list = '';
if ($this->fontColor !== '') {
  $defaults = str_replace(' ', '', $this->fontColor);
...
$localFontsClean = str_replace(' ', '', $this->fontNames);
$localFontsArray = explode(',', $localFontsClean);
$localFonts = '';

foreach ($localFontsArray as $font) {
...
//$field->set( 'notes', __( 'font size' ) );
$field->set('name', __('font-family'));
$field->addClass('label-left', 'wrapClass');
$field->addClass('fonts');
$field->addClass('pg-global');
$field->attr('local-fonts', $localFonts);
//$field->addClass( 'label-margin-left', 'wrapClass' );
//       $field->set( 'icon', __( 'arrows-h' ) );
//$field->addClass( 'hide-label', 'headerClass' );
$field->columnWidth = 100;
$fieldset->append($field);
                      ...
                      <div class="settings_wrap">
                        <div class="drop_target">
                          <div class="input_button"></div>
                            <input class="inputFile" type="file" data-field="" data-id="' . $parentPageId . '"/>
...
$list = '';
if ($this->bgColor !== '') {
  $defaults = str_replace(' ', '', $this->bgColor);
  $defaults = explode(',', $defaults);
  $list = 'list="bgColor"';

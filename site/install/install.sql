# --- WireDatabaseBackup {"time":"2023-12-08 14:16:39","user":"","dbName":"test099876637782974","description":"","tables":[],"excludeTables":["pages_drafts","pages_roles","permissions","roles","roles_permissions","users","users_roles","user","role","permission"],"excludeCreateTables":[],"excludeExportTables":["field_roles","field_permissions","field_email","field_pass","caches","session_login_throttle","page_path_history"]}
...
DROP TABLE IF EXISTS `field_pg_image_caption`;
CREATE TABLE `field_pg_image_caption` (
  `pages_id` int unsigned NOT NULL,
  `data` mediumtext NOT NULL,
  PRIMARY KEY (`pages_id`),
  KEY `data_exact` (`data`(250)),
...
DROP TABLE IF EXISTS `field_pg_video_caption`;
CREATE TABLE `field_pg_video_caption` (
  `pages_id` int unsigned NOT NULL,
  `data` mediumtext NOT NULL,
  PRIMARY KEY (`pages_id`),
  KEY `data_exact` (`data`(250)),
...
INSERT INTO `field_process` (`pages_id`, `data`) VALUES('1303', '284');
...
INSERT INTO `field_title` (`pages_id`, `data`) VALUES('1140', 'Items');
INSERT INTO `field_title` (`pages_id`, `data`) VALUES('1141', 'Classes');
...
INSERT INTO `field_title` (`pages_id`, `data`) VALUES('1303', 'Export Site Profile');
...
INSERT INTO `fieldgroups` (`id`, `name`) VALUES('131', 'pagegrid-page');
...
INSERT INTO `fieldgroups_fields` (`fieldgroups_id`, `fields_id`, `sort`, `data`) VALUES('83', '151', '1', NULL);
...
INSERT INTO `fieldgroups_fields` (`fieldgroups_id`, `fields_id`, `sort`, `data`) VALUES('119', '149', '4', NULL);
INSERT INTO `fieldgroups_fields` (`fieldgroups_id`, `fields_id`, `sort`, `data`) VALUES('110', '107', '3', NULL);
INSERT INTO `fieldgroups_fields` (`fieldgroups_id`, `fields_id`, `sort`, `data`) VALUES('110', '150', '4', NULL);
INSERT INTO `fieldgroups_fields` (`fieldgroups_id`, `fields_id`, `sort`, `data`) VALUES('131', '1', '0', NULL);
INSERT INTO `fieldgroups_fields` (`fieldgroups_id`, `fields_id`, `sort`, `data`) VALUES('131', '151', '1', NULL);
...
INSERT INTO `fields` (`id`, `type`, `name`, `flags`, `label`, `data`) VALUES('111', 'FieldtypePage', 'pg_reference', '0', 'Reference', '{\"tags\":\"PageGrid\",\"inputfield\":\"InputfieldPageListSelect\",\"derefAsPage\":1,\"parent_id\":1,\"labelFieldName\":\"title\",\"contentType\":1}');
...
INSERT INTO `fields` (`id`, `type`, `name`, `flags`, `label`, `data`) VALUES('147', 'FieldtypeTextarea', 'pg_editor', '0', 'Rich Text', '{\"tags\":\"PageGrid\",\"inputfieldClass\":\"InputfieldTinyMCE\",\"contentType\":1,\"htmlOptions\":[2],\"inlineMode\":1,\"features\":[\"toolbar\",\"stickybars\",\"spellcheck\",\"purifier\",\"pasteFilter\"],\"toolbar\":\"styles bold italic pwlink pwimage blockquote hr bullist numlist table anchor code emoticons iconpicker\",\"extPlugins\":[\"\\/site\\/modules\\/PageGridBlocks\\/tinymce_plugins\\/iconpicker\\/iconpicker.js\"]}');
INSERT INTO `fields` (`id`, `type`, `name`, `flags`, `label`, `data`) VALUES('148', 'FieldtypeTextarea', 'pg_text', '0', 'Text', '{\"tags\":\"PageGrid\",\"inputfieldClass\":\"InputfieldTinyMCE\",\"contentType\":1,\"htmlOptions\":[2],\"inlineMode\":1,\"features\":[\"toolbar\",\"stickybars\",\"spellcheck\",\"purifier\",\"pasteFilter\"],\"toolbar\":\"pwlink\",\"plugins\":[\"link\",\"lists\",\"pwlink\"],\"settingsJSON\":\"{\\\"forced_root_block\\\": \\\"div\\\", \\\"newline_behavior\\\": \\\"linebreak\\\", \\\"valid_elements\\\": \\\"div,a[id|class|href],br\\\"}\"}');
...
INSERT INTO `fields` (`id`, `type`, `name`, `flags`, `label`, `data`) VALUES('149', 'FieldtypeTextarea', 'pg_video_caption', '0', 'Caption', '{\"tags\":\"PageGrid\",\"inputfieldClass\":\"InputfieldTinyMCE\",\"contentType\":1,\"htmlOptions\":[2],\"inlineMode\":1,\"features\":[\"toolbar\",\"stickybars\",\"spellcheck\",\"purifier\",\"pasteFilter\"],\"toolbar\":\"pwlink\",\"plugins\":[\"link\",\"lists\",\"pwlink\"],\"settingsJSON\":\"{\\\"forced_root_block\\\": \\\"div\\\", \\\"newline_behavior\\\": \\\"linebreak\\\", \\\"valid_elements\\\": \\\"a[href|target=_blank],br\\\"}\"}');
INSERT INTO `fields` (`id`, `type`, `name`, `flags`, `label`, `data`) VALUES('150', 'FieldtypeTextarea', 'pg_image_caption', '0', 'Caption', '{\"tags\":\"PageGrid\",\"inputfieldClass\":\"InputfieldTinyMCE\",\"contentType\":1,\"htmlOptions\":[2],\"inlineMode\":1,\"features\":[\"toolbar\",\"stickybars\",\"spellcheck\",\"purifier\",\"pasteFilter\"],\"toolbar\":\"pwlink\",\"plugins\":[\"link\",\"lists\",\"pwlink\"],\"settingsJSON\":\"{\\\"forced_root_block\\\": \\\"div\\\", \\\"newline_behavior\\\": \\\"linebreak\\\", \\\"valid_elements\\\": \\\"div,a[id|class|href],br\\\"}\"}');
INSERT INTO `fields` (`id`, `type`, `name`, `flags`, `label`, `data`) VALUES('151', 'FieldtypePageGrid', 'PageGrid', '0', 'pagegrid', '{\"tags\":\"PageGrid\",\"template_id\":[\"pg_editor\",\"pg_text\",\"pg_image\",\"pg_video\",\"pg_iframe\",\"pg_slider\",\"pg_navigation\",\"pg_gallery\",\"pg_gallery_video\",\"pg_marker\",\"pg_datalist\",\"pg_prev_next\",\"pg_sequenz\",\"pg_spacer\",\"pg_group\"]}');
...
) ENGINE=MyISAM AUTO_INCREMENT=286 DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `modules` (`id`, `class`, `flags`, `data`, `created`) VALUES('170', 'PageFrontEdit', '2', '{\"inlineEditFields\":[141,147,150,110,109,148,149],\"inlineLimitPage\":\"0\"}', '2022-09-08 16:57:53');
INSERT INTO `modules` (`id`, `class`, `flags`, `data`, `created`) VALUES('185', 'ProcessForgotPassword', '1', '{\"emailFrom\":\"PWAdmin@pagegrid-profile.test\"}', '2022-09-09 12:25:36');
...
INSERT INTO `modules` (`id`, `class`, `flags`, `data`, `created`) VALUES('259', 'FieldtypePageGrid', '3', '{\"interface\":[\"hideFieldTitle\",\"hidePageHeadline\",\"hideTitleField\",\"hideTabs\",\"hideSaveButton\"],\"interfaceDefault\":0,\"lKey\":\"\",\"collapsedState\":\"ModuleInfo,lKey,fieldSettings,customStyles,uninstall,\",\"stylePanel\":1,\"fontPrivacy\":1,\"deleteFonts\":\"\",\"uploadFonts\":[],\"fallbackFonts\":\"Helvetica, Arial, sans-serif\",\"fontColor\":\"\",\"bgColor\":\"\",\"inlineEditFields\":[141,147,150,110,109,148,149],\"inlineEditFieldsUpload\":[101,102,105,115],\"placeholderText\":\"Click twice to edit this text\",\"customStyles\":\"\",\"plugins\":[\"lazysizes\"],\"pluginsDefault\":0,\"placeholderText_121\":\"Click twice to edit this text\",\"placeholderText_110\":\"\",\"placeholderText_109\":\"\",\"placeholderText_114\":\"Click twice to edit this text\",\"inlineEditorFrontDisable\":1,\"placeholderText_146\":\"Click twice to edit this text\",\"placeholderText_147\":\"Click twice to edit this text\",\"placeholderText_148\":\"Click twice to edit this text\",\"placeholderText_141\":\"\",\"template_id_131\":[\"pg_editor\"],\"addTemplate_151\":[77,29],\"template_id_151\":[\"pg_editor\",\"pg_text\",\"pg_image\",\"pg_video\",\"pg_iframe\",\"pg_slider\",\"pg_navigation\",\"pg_gallery\",\"pg_gallery_video\",\"pg_marker\",\"pg_datalist\",\"pg_prev_next\",\"pg_sequenz\",\"pg_spacer\",\"pg_group\"],\"addTemplate_131\":[],\"placeholderText_149\":\"\",\"placeholderText_150\":\"\",\"deleteFields\":\"\"}', '2023-01-17 16:25:47');
...
) ENGINE=MyISAM AUTO_INCREMENT=1308 DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`) VALUES('2', '1', '2', 'processwire', '1035', '2023-12-08 14:52:01', '40', '2022-09-08 16:37:59', '41', '2022-09-08 16:37:59', '7');
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`) VALUES('41', '29', '3', 'admin', '1', '2023-12-08 14:52:36', '41', '2022-09-08 16:37:59', '41', '2022-09-08 16:37:59', '0');
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`) VALUES('1141', '1268', '52', 'pg-classes', '1025', '2023-12-08 15:15:39', '41', '2022-09-09 12:35:53', '41', '2022-09-09 12:35:53', '7');
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`) VALUES('1260', '30', '4', 'pagegrid-editor', '1', '2023-12-08 15:15:39', '41', '2023-01-17 16:25:47', '41', '2023-01-17 16:25:47', '2');
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`) VALUES('1140', '1268', '52', 'pg-items', '1025', '2023-12-08 15:15:39', '41', '2022-09-09 12:35:53', '41', '2022-09-09 12:35:53', '6');
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`) VALUES('1301', '1297', '76', 'pg-text-1301', '1', '2023-12-08 15:07:10', '41', '2023-10-10 18:12:26', '41', '2023-10-10 18:12:26', '0');
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`) VALUES('1268', '22', '2', 'pagegrid', '1', '2023-12-08 14:52:36', '41', '2023-01-17 16:25:47', '41', '2023-01-17 16:25:47', '5');
...
INSERT INTO `pages` (`id`, `parent_id`, `templates_id`, `name`, `status`, `modified`, `modified_users_id`, `created`, `created_users_id`, `published`, `sort`) VALUES('1297', '1296', '55', 'pg-group-1297', '1', '2023-12-08 15:07:10', '41', '2023-10-10 18:10:44', '41', '2023-10-10 18:10:44', '0');
...
INSERT INTO `pages_meta` (`source_id`, `name`, `data`) VALUES('1297', 'pg_ajax', 'false');
...
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('1', 'home', '1', '0', '0', '{\"useRoles\":1,\"editRoles\":[1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260],\"noParents\":1,\"childTemplates\":[29],\"slashUrls\":1,\"compile\":0,\"modified\":1702044938,\"ns\":\"ProcessWire\",\"_lazy\":1,\"roles\":[37,1260]}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('29', 'basic-page', '83', '0', '0', '{\"slashUrls\":1,\"compile\":0,\"modified\":1702043776,\"ns\":\"ProcessWire\",\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('75', 'pg_editor', '129', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-text-height title\",\"compile\":3,\"label\":\"Rich Text\",\"tags\":\"pagegrid\",\"modified\":1700139523,\"noPrependTemplateFile\":1,\"noAppendTemplateFile\":1,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('54', 'pg_gallery_video', '108', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-video-camera title\",\"compile\":3,\"label\":\"Gallery Video\",\"modified\":1700139523,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('53', 'pg_gallery', '107', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-camera-retro title\",\"compile\":3,\"label\":\"Gallery\",\"modified\":1700139523,\"noPrependTemplateFile\":1,\"noAppendTemplateFile\":1,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('52', 'pg_container', '106', '0', '0', '{\"useRoles\":1,\"editRoles\":[1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260,1260],\"noParents\":-1,\"slashUrls\":1,\"compile\":3,\"modified\":1702044938,\"_lazy\":1,\"roles\":[37,1260]}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('55', 'pg_group', '109', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-folder-open title\",\"compile\":3,\"label\":\"Group\",\"tags\":\"Blocks\",\"modified\":1702044476,\"noPrependTemplateFile\":1,\"noAppendTemplateFile\":1,\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('56', 'pg_image', '110', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-file-image-o title\",\"compile\":3,\"label\":\"Image\",\"tags\":\"pagegrid\",\"modified\":1700139523,\"noPrependTemplateFile\":1,\"noAppendTemplateFile\":1,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('58', 'pg_marker', '112', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-map-pin title\",\"compile\":3,\"label\":\"Marker\",\"modified\":1700139523,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('59', 'pg_navigation', '113', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-bars title\",\"compile\":3,\"label\":\"Navigation\",\"tags\":\"pagegrid\",\"modified\":1700139523,\"noPrependTemplateFile\":1,\"noAppendTemplateFile\":1,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('60', 'pg_reference', '114', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-link title\",\"compile\":3,\"label\":\"Reference\",\"tags\":\"pagegrid\",\"modified\":1700139523,\"noPrependTemplateFile\":1,\"noAppendTemplateFile\":1,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('61', 'pg_sequenz', '115', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-film title\",\"compile\":3,\"label\":\"Sequenz\",\"modified\":1700139523,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('62', 'pg_slider', '116', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-ellipsis-h title\",\"compile\":3,\"label\":\"Slider\",\"modified\":1700139523,\"noPrependTemplateFile\":1,\"noAppendTemplateFile\":1,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('63', 'pg_spacer', '117', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-arrows-h title\",\"compile\":3,\"label\":\"Spacer\",\"modified\":1700139523,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('76', 'pg_text', '130', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-font title\",\"compile\":3,\"label\":\"Text\",\"tags\":\"Blocks\",\"modified\":1702044476,\"noPrependTemplateFile\":1,\"noAppendTemplateFile\":1,\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('65', 'pg_video', '119', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-file-video-o title\",\"compile\":3,\"label\":\"Video\",\"modified\":1700139523,\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('70', 'pg_blueprint', '124', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-th title\",\"compile\":3,\"tags\":\"pagegrid\",\"modified\":1701884222,\"ns\":\"ProcessWire\",\"_lazy\":1}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('71', 'pg_datalist', '125', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-list title\",\"compile\":3,\"label\":\"Datalist\",\"modified\":1700139523,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('72', 'pg_iframe', '126', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-file-code-o title\",\"compile\":3,\"label\":\"Iframe\",\"modified\":1700139523,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('73', 'pg_prev_next', '127', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-exchange title\",\"compile\":3,\"label\":\"Previous\\/Next\",\"modified\":1700139523,\"_lazy\":\"*\"}');
INSERT INTO `templates` (`id`, `name`, `fieldgroups_id`, `flags`, `cache_time`, `data`) VALUES('77', 'pagegrid-page', '131', '0', '0', '{\"slashUrls\":1,\"pageLabelField\":\"fa-th title\",\"compile\":3,\"modified\":1702043525}');

UPDATE pages SET created_users_id=41, modified_users_id=41, created=NOW(), modified=NOW();

# --- /WireDatabaseBackup {"numTables":58,"numCreateTables":64,"numInserts":567,"numSeconds":0}